 ...
 */
public class FragmentYardsToMeters extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View myView = inflater.inflate(R.layout.fragment_formula_yardstometers, container, false);
    ...
    public void onClick (View v) {
        ...
        switch (v.getId()) {
            case R.id.btnCalc:
                ...
                String sAnswer = etMeters.getText().toString() + " yards coverts to <b>" + dYards + "</b> meters";
